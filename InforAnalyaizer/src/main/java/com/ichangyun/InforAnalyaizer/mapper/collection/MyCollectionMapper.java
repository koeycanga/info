...
public interface MyCollectionMapper {
    ...
    //全文匹配
    List<MyCollectionVo> queryAllO1(Map<String, Object> key);
    //标题匹配
    List<MyCollectionVo> queryAllO2(Map<String, Object> key);
    //摘要匹配
    List<MyCollectionVo> queryAllO3(Map<String, Object> key);
    //内容匹配
    List<MyCollectionVo> queryAllO4(Map<String, Object> key);
    //全文匹配
    int queryCountO1(Map<String, Object> key);
    //标题匹配
    int queryCountO2(Map<String, Object> key);
    //摘要匹配
    int queryCountO3(Map<String, Object> key);
    //内容匹配
    int queryCountO4(Map<String, Object> key);
