...
<script>
    ...
    var ic_tree_dv_checkbox = {
        ...
        '<div v-show="model.is_show" v-bind:style="t_style"><ic_tree_dv_checkbox  v-for="model in model.children"  v-bind:model="model"></ic_tree_dv_checkbox></div></div>' ,
        props: ['model'],
        data: function () {
            return {
    ...
    var ic_tree_dv_name = {
        ...
        '<div :v-show="model.is_show" v-bind:style="t_style"><ic_tree_dv_name  v-for="model in model.children" v-bind:model="model"></ic_tree_dv_name></div></div>'
        ,
        props: ['model'],
        ...
        methods: {
                    opClose: function (id) {
                        ...
                        $.ajax({
                            url:"queryChild",
                            data:{ "parent_Classification_ID":id},
                            dateType:"json",
                            type:"get",
                            async:false, 
                        ...
                        this.$parent.fwVos.forEach(function (vo) {
                            if(vo.classificationId==_this.model.classificationId){
                            	vo.children = children;
                            	vo.is_show = !vo.is_show;
    ...
    var ic_tree_dv_tropism = {
        ...
        '<div v-show="model.is_show" v-bind:style="t_style"><span> </span><span> </span><ic_tree_dv_tropism  v-for="model in model.children" v-bind:model="model"></ic_tree_dv_tropism></div></div>'
        ,
        props: ['model'],
        data: function () {
            return {
    ...
    var ic_tree_dv_all = {
        ...
        '<div v-show="model.is_show" v-bind:style="t_style"><span> </span><span> </span><ic_tree_dv_all  v-for="model in model.children" v-bind:model="model"></ic_tree_dv_all></div></div>'
        ,
        props: ['model'],
        data: function () {
            return {
    ...
    var ic_tree_dv_time = {
        ...
        '<div v-show="model.is_show" v-bind:style="t_style"><span> </span><span> </span><ic_tree_dv_time  v-for="model in model.children" v-bind:model="model"></ic_tree_dv_time></div></div>'
        ,
        props: ['model'],
        data: function () {
            return {
    ...
    var ic_tree_dv_user = {
        ...
        '<div v-show="model.is_show" v-bind:style="t_style"><span> </span><span> </span><ic_tree_dv_user  v-for="model in model.children" v-bind:model="model"></ic_tree_dv_user></div></div>'
        ,
        props: ['model'],
        data: function () {
            return {
